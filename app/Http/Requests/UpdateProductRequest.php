...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sku' => 'nullable|string|max:100|unique:products,sku,' . ($this->route('product') ? $this->route('product')->id : null),
            'serial_number' => 'nullable|string|max:100|unique:products,serial_number,' . ($this->route('product') ? $this->route('product')->id : null),
